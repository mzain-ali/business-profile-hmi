...
export const about = {
  ...
  stats: [
    { num: "Same-Day", label: "Parts Availability" },
  ...
  machineTypes: [
    ...
    { id: "telehandler", label: "Telehandler", img: "/assets/machines/telehandler.jpg" },
    { id: "roller", label: "Road Roller", img: "/assets/machines/roller.png" },
    { id: "crane", label: "Crane", img: "/assets/machines/crane.png" },
    { id: "tractor", label: "Tractor", img: "/assets/machines/tractor.jpg" },
...
export const whyUs = {
  ...
  cards: [
    { icon: "pin" as const, accent: "orange" as const, title: "Live stock", body: "Ghala (Muscat) and Salalah both hold live inventory \u2014 not a single warehouse hours away. Most local parts move same day." },
  ...
  audience: [
    { id: "contractor", label: "Contractors", img: "/assets/whyUs/contractors.jpg" },
    { id: "fleet", label: "Fleet Managers", img: "/assets/whyUs/fleet-managers.jpg" },
    { id: "workshop", label: "Workshop Owners", img: "/assets/whyUs/workshop-owners.jpg" },
  ],
};
...
export const services = {
  ...
  items: [
    {
      img: "/assets/services/parts-supply.jpg",
    ...
    {
      img: "/assets/services/battery-regeneration.jpg",
    ...
    {
      img: "/assets/services/glass-fixing.jpg",
...
export const brands = {
  ...
  items: [
    { name: "Dig & Lift", logo: "/assets/brands/dig-and-lift.jpg" },
    { name: "Rotex", logo: "/assets/brands/rotex.jpg" },
    { name: "Komatsu", logo: "/assets/brands/komatsu.jpg" },
    { name: "TKS", logo: "/assets/brands/tks.jpg" },
    { name: "Perkins", logo: "/assets/brands/perkins.jpg" },
    { name: "Carraro", logo: "/assets/brands/carraro.jpg" },
    { name: "Volvo", logo: "/assets/brands/volvo.jpg" },
    { name: "ZF", logo: "/assets/brands/zf.jpg" },
    { name: "Toyota", logo: "/assets/brands/toyota.jpg" },
    { name: "Mitsubishi", logo: "/assets/brands/mitsubishi.jpg" },
    { name: "Caterpillar", logo: "/assets/brands/caterpillar.jpg" },
    { name: "Hyster", logo: "/assets/brands/hyster.jpg" },
    { name: "TCM", logo: "/assets/brands/tcm.jpg" },
    { name: "Yale", logo: "/assets/brands/yale.jpg" },
    { name: "Doosan", logo: "/assets/brands/doosan.jpg" },
    { name: "Massey Ferguson", logo: "/assets/brands/massey-ferguson.jpg" },
    { name: "Nissan", logo: "/assets/brands/nissan.jpg" },
    { name: "SDLG", logo: "/assets/brands/sdlg.jpg" },
    { name: "JCB", logo: "/assets/brands/jcb.jpg" },
    { name: "Hitachi", logo: "/assets/brands/hitachi.jpg" },
    { name: "Zoomlion", logo: "/assets/brands/zoomlion.jpg" },
    { name: "XCMG", logo: "/assets/brands/xcmg.jpg" },
    { name: "Sany", logo: "/assets/brands/sany.jpg" },
    { name: "John Deere", logo: "/assets/brands/john-deere.jpg" },
    { name: "Bobcat", logo: "/assets/brands/bobcat.jpg" },
    { name: "Manitou", logo: "/assets/brands/manitou.jpg" },
    { name: "Bomag", logo: "/assets/brands/bomag.jpg" },
    { name: "Dynapac", logo: "/assets/brands/dynapac.jpg" },
    { name: "Hamm", logo: "/assets/brands/hamm.jpg" },
    { name: "Still", logo: "/assets/brands/still.jpg" },
    { name: "Jungheinrich", logo: "/assets/brands/jungheinrich.jpg" },
    { name: "Heli", logo: "/assets/brands/heli.jpg" },
    { name: "Linde", logo: "/assets/brands/linde.jpg" },
  ],
};
...
export const locations = {
  ...
  branches: [
    {
      name: "Muscat Branch",
      photo: "/assets/locations/muscat-branch.jpg",
      pin: "Ghala, Muscat",
    ...
    {
      name: "Salalah Branch",
      photo: "/assets/locations/salalah.jpg",
...
export const contact = {
  ...
  sub: "Message us your machine and part details, we’ll confirm stock and price fast.",
  highlights: [
  ...
  cols: [
    ...
    { icon: "envelope" as const, accent: "navy" as const, label: "Email", value: "hassan.mushtaq@hmi-parts.com" },
    { icon: "globe" as const, accent: "orange" as const, label: "Website", value: "www.hmi-parts.com" },
  ],
  ctaLabel: "Chat on WhatsApp (+968 7733 0777)",
